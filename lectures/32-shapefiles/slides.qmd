...
[^1]: `.shp` and `.dbf` are in binary file format: cannot be opened firectly in a text editor to read the content.
...
To visualize fire perimeters on a map of California we need to get data for the polygon(s) of California.
