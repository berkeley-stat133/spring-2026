...
## JSON array and object {auto-animate=true}
...
How would you store Leis's data using a:
...
![](images/leia-luke-han-info.svg){width="54%" fig-align="center"}

How would you store this data using a:
