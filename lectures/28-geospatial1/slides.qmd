...
:::: {.columns}
::: {.column width="45%"}
A [Coordinate Reference System]{.bold-hilit}, or CRS, is a system for associating coordinates  with a specific, unambiguous location on the surface of the Earth.
:::
...
## Vector Data Geometries and Attributes {.nostretch}
...
A group of features is called a __layer__.
...
:::: {.columns}
::: {.column width="50%"}
Vector data are better for [discretely bounded data]{.hilit}, e.g. bike racks, rivers, political boundaries, etc.

![](images/vector-features.png)
:::

::: {.column .fragment  width="50%"}
Raster data are better for [continuous data]{.mdlit}, e.g. temperature, elevation, rainfall, etc.
