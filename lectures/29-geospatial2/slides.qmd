...
- The data includes the positions and attributes of storms from 1975-2024. 
...
What [vector geometries]{.hilit} are in this map?

```{r}
#| echo: false
countdown::countdown(0.75, bottom = 0)
```
:::
::::
...
We have 3 kinds of geometries:

1) Polygons of Countries
2) Points of Storm locations
3) Lines of Storm tracks
...
library(sf)             # simple features (vector objects)
...
- By default `geom_sf()` uses the __Plate Carrée__ (equirectangular) projection when plotting data in a geographic system like WGS 84.
...
![](images/storm-track-workflow1.svg){width="100%" fig-align="center"}
