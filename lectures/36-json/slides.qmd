...
But you also need to learn how to get data from the web.
...
- An increasing number of APIs have adopted a common format to share data: [JSON]{.bold-hilit}
...
toJSON(leia_lst, auto_unbox = FALSE, pretty = TRUE)
```
