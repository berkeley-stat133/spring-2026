...
4. When you're ready to deploy, use the quarto package (first install.packages('quarto') then library(quarto)). Then run quarto_publish_app("your_dashboard.qmd", server = "shinyapps.io")
